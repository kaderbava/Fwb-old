...
public class Cam constructor(
    ...
    public fun distance(other: Cam): Double {
    ...
    public fun viewed(frame: Frame): Int {
    ...
    companion object {
        public const val CHROMA_SEARCH_ENDPOINT = 0.4
        public const val DE_MAX = 1.0
        public const val DL_MAX = 0.2
        public const val LIGHTNESS_SEARCH_ENDPOINT = 0.01

        public fun getInt(hue: Double, chroma: Double, lstar: Double): Int {
            return getInt(hue, chroma, lstar, Frame.DEFAULT)
        }

        public fun fromInt(argb: Int): Cam {
            return fromIntInFrame(argb, Frame.DEFAULT)
        }

        public fun fromIntInFrame(argb: Int, frame: Frame): Cam {
            val hue: Double
        ...
        public fun fromJch(j: Double, c: Double, h: Double): Cam {
            return fromJchInFrame(j, c, h, Frame.DEFAULT)
        }

        public fun fromJchInFrame(j: Double, c: Double, h: Double, frame: Frame): Cam {
            val q = 4.0 / frame.c * sqrt(j / 100.0) * (frame.aw + 4.0) * frame.flRoot
        ...
        public fun getInt(hue: Double, chroma: Double, lstar: Double, frame: Frame): Int {
        ...
        public fun findCamByJ(hue: Double, chroma: Double, lstar: Double): Cam? {
            var low = 0.0
            var high = 100.0
            var bestdL = 1000.0
            var bestdE = 1000.0

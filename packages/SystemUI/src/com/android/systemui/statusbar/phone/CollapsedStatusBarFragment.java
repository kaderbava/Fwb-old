...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks,
    ...
    private ImageView mAncientLogo;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAncientLogo = (ImageView)mStatusBar.findViewById(R.id.status_bar_logo);
        Dependency.get(DarkIconDispatcher.class).addDarkReceiver(mAncientLogo);
    ...
    public void onDestroyView() {
        ...
        Dependency.get(DarkIconDispatcher.class).removeDarkReceiver(mAncientLogo);
    }
...
*/
    ...
    public void hideNotificationIconArea(boolean animate) {
        ...
        if (mShowLogo) {
            animateHide(mAncientLogo, animate, true);
        }
    }
    ...
    public void showNotificationIconArea(boolean animate) {
        ...
        if (mShowLogo) {
            animateShow(mAncientLogo, animate);
        }
    }
